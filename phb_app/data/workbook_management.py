...
class WorkbookManager:
    ...
    def add_workbook(self, file_path: str, role: common.IORole) -> None:
        '''Add input workbooks by filename.'''
        workbook = Mng_wb_dispatch[role](file_path=file_path)
        self.try_add_workbook(workbook)

    def get_workbook_by_name(self, file_name: str) -> common.ManagedInputWorkbook | common.ManagedOutputWorkbook | None:
    ...
    def yield_workbooks_by_type(self, wb_class: common.ManagedInputWorkbook | common.ManagedOutputWorkbook) -> Iterator[common.ManagedInputWorkbook | common.ManagedOutputWorkbook]:
